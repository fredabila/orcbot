...
const SKILLS: Skill[] = [
  ...
  { name: 'github_cli_status',  sig: 'github_cli_status()',                           desc: 'Check whether the GitHub CLI is installed and authenticated.',                    tags: ['system', 'dev'] },
  { name: 'github_cli_command', sig: 'github_cli_command(args:array, json?, cwd?)',  desc: 'Run a structured gh command without a shell.',                                    tags: ['system', 'dev'] },
  { name: 'github_branch_list', sig: 'github_branch_list(repo?, limit?, query?, cwd?)', desc: 'List repository branches through gh.',                                          tags: ['system', 'dev'] },
  { name: 'github_label_list',  sig: 'github_label_list(repo?, limit?, search?, cwd?)', desc: 'List repository labels through gh.',                                           tags: ['system', 'dev'] },
  { name: 'github_label_create',sig: 'github_label_create(name, color, description?, force?, repo?, cwd?)', desc: 'Create or update a repository label through gh.',        tags: ['system', 'dev'] },
  { name: 'github_label_delete',sig: 'github_label_delete(name, repo?, cwd?)', desc: 'Delete a repository label through gh.',                                                tags: ['system', 'dev'] },
  { name: 'github_pr_list',     sig: 'github_pr_list(state?, limit?, repo?, base?, head?, author?, assignee?, cwd?)', desc: 'List pull requests through gh with optional filters.', tags: ['system', 'dev'] },
  { name: 'github_pr_checks',   sig: 'github_pr_checks(pull_request, repo?, watch?, cwd?)', desc: 'Inspect status checks for a pull request through gh.',                     tags: ['system', 'dev'] },
  { name: 'github_pr_review',   sig: 'github_pr_review(pull_request, event, body?, repo?, cwd?)', desc: 'Submit a pull request review through gh.',                          tags: ['system', 'dev'] },
  { name: 'github_pr_comment',  sig: 'github_pr_comment(pull_request, body, repo?, cwd?)', desc: 'Post a plain comment on a pull request through gh.',                       tags: ['system', 'dev'] },
  { name: 'github_pr_merge',    sig: 'github_pr_merge(pull_request, strategy?, subject?, body?, auto?, admin?, delete_branch?, match_head_commit?, repo?, cwd?)', desc: 'Merge a pull request through gh.', tags: ['system', 'dev'] },
  { name: 'github_issue_create',sig: 'github_issue_create(title, body?, repo?, labels?, assignees?, cwd?)', desc: 'Create a GitHub issue through gh.',                           tags: ['system', 'dev'] },
  { name: 'github_issue_comment',sig: 'github_issue_comment(issue, body, repo?, cwd?)', desc: 'Post a plain comment on a GitHub issue through gh.',                          tags: ['system', 'dev'] },
  { name: 'github_release_create',sig: 'github_release_create(tag, title?, notes?, repo?, target?, draft?, prerelease?, generate_notes?, cwd?)', desc: 'Create a GitHub release through gh.', tags: ['system', 'dev'] },
  { name: 'github_release_upload_asset', sig: 'github_release_upload_asset(tag, files, repo?, clobber?, cwd?)', desc: 'Upload files to an existing GitHub release through gh.', tags: ['system', 'dev'] },
  { name: 'github_variable_list', sig: 'github_variable_list(repo?, limit?, cwd?)', desc: 'List repository variables through gh.',                                            tags: ['system', 'dev'] },
  { name: 'github_variable_set', sig: 'github_variable_set(name, value, repo?, visibility?, cwd?)', desc: 'Create or update a repository variable through gh.',             tags: ['system', 'dev'] },
  { name: 'github_variable_delete', sig: 'github_variable_delete(name, repo?, cwd?)', desc: 'Delete a repository variable through gh.',                                      tags: ['system', 'dev'] },
  { name: 'github_workflow_runs', sig: 'github_workflow_runs(workflow?, branch?, event?, status?, limit?, repo?, user?, cwd?)', desc: 'List GitHub Actions workflow runs through gh.', tags: ['system', 'dev'] },
  { name: 'github_workflow_dispatch', sig: 'github_workflow_dispatch(workflow, ref?, fields?, repo?, cwd?)', desc: 'Dispatch a GitHub Actions workflow through gh.',         tags: ['system', 'dev'] },
  { name: 'github_workflow_rerun', sig: 'github_workflow_rerun(run_id, failed?, repo?, cwd?)', desc: 'Rerun a GitHub Actions workflow run through gh.',                     tags: ['system', 'dev'] },
