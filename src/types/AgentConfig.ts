...
export const AgentConfigSchema = z.object({
    ...
    githubCliPath: z.string().optional(),
    ...
    lightweightHeartbeatEnabled: coerceBool.default(true),
    lightweightHeartbeatIntervalMinutes: coerceNumber.default(10),
    ...
    whatsappStatusMediaMode: z.enum(['off', 'download_only', 'download_and_analyze']).default('off'),
    whatsappAutoReactEnabled: coerceBool.default(false),
    whatsappContextProfilingEnabled: coerceBool.default(false),
    whatsappContactAccessMode: z.enum(['all', 'allowlist', 'blocklist']).default('all'),
    whatsappAllowedContacts: z.array(z.string()).default([]),
    whatsappBlockedContacts: z.array(z.string()).default([]),
    whatsappGroupsEnabled: coerceBool.default(false),
    whatsappGroupPolicy: z.enum(['all', 'mention_only', 'owner_only', 'allowlist']).default('mention_only'),
    whatsappAllowedGroups: z.array(z.string()).default([]),
    whatsappBlockedGroups: z.array(z.string()).default([]),
    whatsappOwnerJID: z.string().optional(),
    telegramAutoReplyEnabled: coerceBool.default(false),
    telegramChannelsEnabled: coerceBool.default(false),
    telegramGroupsEnabled: coerceBool.default(false),
    telegramGroupPolicy: z.enum(['all', 'mention_only', 'reply_only', 'allowlist']).default('mention_only'),
    telegramAllowedGroups: z.array(z.string()).default([]),
    telegramBlockedGroups: z.array(z.string()).default([]),
    ...
    commandAllowList: z.array(z.string()).default([
        'npm', 'node', 'npx', 'git', 'gh', 'python', 'pip', 'pip3', 'curl', 'wget', 'powershell',
    ...
    worldEventsHeartbeatEnabled: coerceBool.default(false),
    ...
    mcpPort: coerceNumber.default(3190),
    ...
    selfTrainingEnabled: coerceBool.default(true),
    selfTrainingRedactSensitiveData: coerceBool.default(true),
    selfTrainingMinQualityScore: coerceNumber.default(0.72),
    selfTrainingMaxTrajectories: coerceNumber.default(1000),
    selfTrainingTrainOnIdle: coerceBool.default(true),
    selfTrainingMinAcceptedExamples: coerceNumber.default(25),
    selfTrainingPreparationCooldownMinutes: coerceNumber.default(60),
    selfTrainingEvalSampleSize: coerceNumber.default(10),
    selfTrainingEvalPassThreshold: coerceNumber.default(0.55),
    selfTrainingLaunchCommand: z.string().optional(),
    selfTrainingLaunchCwd: z.string().optional(),
    selfTrainingLaunchSessionPrefix: z.string().default('self-train'),
    selfTrainingStorePath: z.string().optional(),
    selfTrainingExportPath: z.string().optional(),
    selfTrainingJobManifestPath: z.string().optional(),
    selfTrainingEvalReportPath: z.string().optional(),
    selfTrainingLaunchRecordPath: z.string().optional(),
    selfTrainingCandidateRegistryPath: z.string().optional(),
    selfTrainingPromotionRecordPath: z.string().optional(),
    selfTrainingPromotionMinAverageScore: coerceNumber.default(0.7),
    selfTrainingRequireEvalForPromotion: coerceBool.default(true),
