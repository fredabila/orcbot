...
export class ConfigManager {
    ...
    private loadConfig(customPath?: string, silent: boolean = false): AgentConfig {
        ...
        const envConfig: Partial<AgentConfig> = {
            ...
            lightweightHeartbeatEnabled: process.env.LIGHTWEIGHT_HEARTBEAT_ENABLED ? String(process.env.LIGHTWEIGHT_HEARTBEAT_ENABLED).toLowerCase() === 'true' : undefined,
            lightweightHeartbeatIntervalMinutes: process.env.LIGHTWEIGHT_HEARTBEAT_INTERVAL_MINUTES ? Number(process.env.LIGHTWEIGHT_HEARTBEAT_INTERVAL_MINUTES) : undefined,
            ...
            worldEventsHeartbeatEnabled: process.env.WORLD_EVENTS_HEARTBEAT_ENABLED ? String(process.env.WORLD_EVENTS_HEARTBEAT_ENABLED).toLowerCase() === 'true' : undefined,
            mcpHost: process.env.MCP_HOST,
            mcpPort: process.env.MCP_PORT ? Number(process.env.MCP_PORT) : undefined,
    ...
    private syncEnvForKey(key: string, value: any) {
        const envMap: Record<string, string> = {
            ...
            googleWorkspaceCliPath: 'GOOGLE_WORKSPACE_CLI_PATH',
            googleWorkspaceCliAccount: 'GOOGLE_WORKSPACE_CLI_ACCOUNT',
