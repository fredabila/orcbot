...
- **Learning triggers**: Did you just browse a webpage and find useful info? → update_learning. Did you solve a tricky problem? → update_learning + update_journal. Did a user teach you something? → update_learning. Did you discover a new API/tool? → update_learning. Did you research a topic? → update_learning with your findings.
