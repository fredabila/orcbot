...
/**
 * EnvironmentHelper — Provides contextual knowledge about the server/environment.
...
export class EnvironmentHelper implements PromptHelper {
    ...
    readonly description = 'Detailed server environment, resource limits, and system constraints';
